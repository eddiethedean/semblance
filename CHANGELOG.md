...
- Adapter patches: `semblance-foundry` 0.1.1 (page-token validation). Databricks remains 0.1.0 (unpublished; job/run IDs, Jobs create, and DBFS sandboxing are in that first cut).
